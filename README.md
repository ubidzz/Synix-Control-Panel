...
> [![CodeQL Analysis](https://github.com/ubidzz/Synix-Control-Panel/actions/workflows/codeql.yml/badge.svg?branch=master)](https://github.com/ubidzz/Synix-Control-Panel/actions/workflows/codeql.yml)
