...
namespace Synix_Control_Panel.SynixApp.UI.Configuration
{
	partial class ServerConfig
	{
		...
		private void InitializeComponent()
		{
			...
			pnlSearch = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard();
			lblSearchGlyph = new Label();
			txtSearch = new TextBox();
			cmbTypeFilter = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsComboBox();
			btnValidateConfig = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsButton();
			btnStructured = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsButton();
			btnRawPreview = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsButton();
			pnlPreservationBanner = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard();
			lblShieldGlyph = new Label();
			lblPreservationTitle = new Label();
			lblPreservationText = new Label();
			pnlGridCard = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard();
			...
			btnFixConfig = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsButton();
			btnRestoreBackup = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsButton();
			btnReset = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsButton();
			btnCancel = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsButton();
			btnSave = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsButton();
		...
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard pnlSearch;
		private Label lblSearchGlyph;
		private TextBox txtSearch;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsComboBox cmbTypeFilter;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsButton btnValidateConfig;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsButton btnStructured;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsButton btnRawPreview;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard pnlPreservationBanner;
		private Label lblShieldGlyph;
		private Label lblPreservationTitle;
		private Label lblPreservationText;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard pnlGridCard;
		...
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsButton btnFixConfig;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsButton btnRestoreBackup;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsButton btnReset;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsButton btnCancel;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsButton btnSave;
	}
}
