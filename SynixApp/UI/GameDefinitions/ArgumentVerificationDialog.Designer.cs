...
namespace Synix_Control_Panel.SynixApp.UI.GameDefinitions
{
	partial class ArgumentVerificationDialog
	{
		...
		private void InitializeComponent()
		{
			...
			_titleLabel.Text = LocalizationManager.Get("Text.20A878B1B65D4056AC2D");
			...
			_subtitleLabel.Text = LocalizationManager.Get("Text.1263E823649071566AFC");
			...
			_instanceLabel.Text = LocalizationManager.Get("Text.986665E0A02097AB3A6B");
			...
			_executableLabel.Text = LocalizationManager.Get("Text.B540E2275FD81A204A01");
			...
			_workingDirectoryLabel.Text = LocalizationManager.Get("Text.74CCD43303847F265530");
			...
			_argumentsLabel.Text = LocalizationManager.Get("Text.F8B175CAB826686FEA88");
			...
			_checkColumn.HeaderText = LocalizationManager.Get("Text.2C12824B5F626268A103");
			_checkColumn.Name = "_checkColumn";
			_checkColumn.ReadOnly = true;
			_checkColumn.Width = 190;
			_resultColumn.HeaderText = LocalizationManager.Get("Text.A67D2A6C9087C1BCB7E7");
			...
			_detailsColumn.HeaderText = LocalizationManager.Get("Text.14FDC0F6C77F7978B7AD");
			...
			_confirmationCheck.Text = LocalizationManager.Get("Text.4E469076738CB74F0877");
			...
			_statusLabel.Text = LocalizationManager.Get("Text.F576F35548B3364CBEDB");
			...
			_validateButton.Text = LocalizationManager.Get("Text.932B6CA1C188CE565F52");
			...
			_startButton.Text = LocalizationManager.Get("Text.28C45B32A2F9334AD511");
			...
			_stopButton.Text = LocalizationManager.Get("Text.CB7C1E8DC21E59830716");
			...
			_markButton.Text = LocalizationManager.Get("Text.16EDF686DF9F75A26826");
			...
			Text = LocalizationManager.Get("Text.B2060EFF487D034B8C89");
