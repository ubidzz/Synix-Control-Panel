...
namespace Synix_Control_Panel.SynixApp.UI.Settings
{
	partial class AppSettings
	{
		...
		private void InitializeComponent()
		{
			...
			btnGeneral = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsNavButton();
			btnBackups = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsNavButton();
			btnPrivacy = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsNavButton();
			btnReportProblem = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsNavButton();
			btnAdvanced = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsNavButton();
			btnDevelopment = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsNavButton();
		...
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsNavButton btnGeneral;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsNavButton btnBackups;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsNavButton btnPrivacy;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsNavButton btnReportProblem;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsNavButton btnAdvanced;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsNavButton btnDevelopment;
