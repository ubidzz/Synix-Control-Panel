...
namespace Synix_Control_Panel.SynixApp.UI.Diagnostics
{
	partial class ResourceMonitorGUI
	{
		...
		private void InitializeComponent()
		{
			...
			pnlCpuCard = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard();
			glyphCpu = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsGlyph();
			...
			pnlRamCard = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard();
			glyphRam = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsGlyph();
			...
			pnlActiveServersCard = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard();
			glyphActiveServers = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsGlyph();
		...
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard pnlCpuCard;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsGlyph glyphCpu;
		...
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard pnlRamCard;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsGlyph glyphRam;
		...
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard pnlActiveServersCard;
		private Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsGlyph glyphActiveServers;
