...
namespace Synix_Control_Panel.SynixApp.UI.Dashboard
{
	partial class MainGUI
	{
		...
		private void InitializeComponent()
		{
			...
			installedCard = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard();
			lblInstalledCaption = new Label();
			lblInstalledValue = new Label();
			lblInstalledHint = new Label();
			runningCard = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard();
			lblRunningCaption = new Label();
			lblRunningValue = new Label();
			lblRunningHint = new Label();
			cpuCard = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard();
			lblCpuCaption = new Label();
			lblCpuValue = new Label();
			lblCpuHint = new Label();
			cpuGauge = new Synix_Control_Panel.SynixApp.Design.Controls.SynixGauge();
			ramCard = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard();
			lblRamCaption = new Label();
			lblRamValue = new Label();
			lblRamHint = new Label();
			ramGauge = new Synix_Control_Panel.SynixApp.Design.Controls.SynixGauge();
			serversCard = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard();
			lblServersTitle = new Label();
			lblServersCount = new Label();
			btnAddServer = new Synix_Control_Panel.SynixApp.Design.Controls.SynixButton();
			searchPanel = new Panel();
			lblSearchIcon = new Label();
			txtServerSearch = new TextBox();
			cmbStatusFilter = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsComboBox();
			...
			activityCard = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard();
			lblActivityTitle = new Label();
			btnClearLog = new Button();
			rtbLog = new RichTextBox();
			networkCard = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard();
			lblNetworkTitle = new Label();
			lblPublicIP = new Label();
			lblLocalIP1 = new Label();
			actionCard = new Synix_Control_Panel.SynixApp.Design.Controls.ModernSettingsCard();
			picSelectedServer = new PictureBox();
			lblSelectedGame = new Label();
			lblSelectedServerName = new Label();
			btnReadiness = new Synix_Control_Panel.SynixApp.Design.Controls.SynixButton();
			btnServerOptions = new Synix_Control_Panel.SynixApp.Design.Controls.SynixButton();
			btnConfigure = new Synix_Control_Panel.SynixApp.Design.Controls.SynixButton();
			btnStart = new Synix_Control_Panel.SynixApp.Design.Controls.SynixButton();
			btnRestart = new Synix_Control_Panel.SynixApp.Design.Controls.SynixButton();
			btnStop = new Synix_Control_Panel.SynixApp.Design.Controls.SynixButton();
			footerPanel = new Panel();
			lblSteamStatus = new Label();
			lblUpdateStatus = new Label();
			btnDownloadUpdate = new Synix_Control_Panel.SynixApp.Design.Controls.SynixButton();
		...
		private SynixApp.Design.Controls.ModernSettingsCard installedCard;
		private Label lblInstalledCaption;
		private Label lblInstalledValue;
		private Label lblInstalledHint;
		private SynixApp.Design.Controls.ModernSettingsCard runningCard;
		private Label lblRunningCaption;
		private Label lblRunningValue;
		private Label lblRunningHint;
		private SynixApp.Design.Controls.ModernSettingsCard cpuCard;
		private Label lblCpuCaption;
		private Label lblCpuValue;
		private Label lblCpuHint;
		private SynixApp.Design.Controls.SynixGauge cpuGauge;
		private SynixApp.Design.Controls.ModernSettingsCard ramCard;
		private Label lblRamCaption;
		private Label lblRamValue;
		private Label lblRamHint;
		private SynixApp.Design.Controls.SynixGauge ramGauge;
		private SynixApp.Design.Controls.ModernSettingsCard serversCard;
		private Label lblServersTitle;
		private Label lblServersCount;
		private SynixApp.Design.Controls.SynixButton btnAddServer;
		private Panel searchPanel;
		private Label lblSearchIcon;
		private TextBox txtServerSearch;
		private SynixApp.Design.Controls.ModernSettingsComboBox cmbStatusFilter;
		...
		private SynixApp.Design.Controls.ModernSettingsCard activityCard;
		private Label lblActivityTitle;
		private Button btnClearLog;
		private RichTextBox rtbLog;
		private SynixApp.Design.Controls.ModernSettingsCard networkCard;
		private Label lblNetworkTitle;
		private Label lblPublicIP;
		private Label lblLocalIP1;
		private SynixApp.Design.Controls.ModernSettingsCard actionCard;
		private PictureBox picSelectedServer;
		private Label lblSelectedGame;
		private Label lblSelectedServerName;
		private SynixApp.Design.Controls.SynixButton btnReadiness;
		private SynixApp.Design.Controls.SynixButton btnServerOptions;
		private SynixApp.Design.Controls.SynixButton btnConfigure;
		private SynixApp.Design.Controls.SynixButton btnStart;
		private SynixApp.Design.Controls.SynixButton btnRestart;
		private SynixApp.Design.Controls.SynixButton btnStop;
		private Panel footerPanel;
		private Label lblSteamStatus;
		private Label lblUpdateStatus;
		private SynixApp.Design.Controls.SynixButton btnDownloadUpdate;
