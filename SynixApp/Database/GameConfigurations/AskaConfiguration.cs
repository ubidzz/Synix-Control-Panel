...
{
	internal sealed class AskaConfiguration : TemplateConfigurationDefinition
	{
		private static readonly ConfigurationTemplate[] Files =
		[
			new("server_settings.json",
				"""{ "ServerName": "{ServerName}", "Password": "{Password}", "MaxPlayers": {MaxPlayers} }""")
		];
