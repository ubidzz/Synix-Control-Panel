	...
	public static class GameDatabase
	{
		...
		[
			...
			new() {
				...
				RequiredArgs = "-nographics -batchmode -name \"{ServerName}\" -port {port} -world \"{map}\" -password \"{pass}\" -SteamAppId={steamAppID}",
				Port = 2456,
				QueryPort = 2457,
				Format = ConfigFormat.StandardINI,
				Maps = ["Dedicated"]
			...
			new() {
				...
				AppID = "232250",
				ExeName = "srcds.exe",
				RequiredArgs = "-game tf -console -port {port} +maxplayers {MaxPlayers} +map {map} +sv_password \"{pass}\" +hostname \"{ServerName}\" {rcon} -SteamAppId={steamAppID}",
			...
			new() {
				...
				AppID = "222860",
				ExeName = "srcds.exe",
				RequiredArgs = "-game left4dead2 -console -port {port} +maxplayers {MaxPlayers} +map {map} +mp_gamemode {mode} +hostname \"{ServerName}\" {rcon} +sv_password \"{pass}\" -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "-batchmode -nographics -autostart -loadlatest {map} -settings StartLocalHost true ServerVisible true ServerMaxPlayers {MaxPlayers} ServerPort {port} ServerName \"{ServerName}\" ServerPassword \"{pass}\" -SteamAppId={steamAppID}",
				Port = 27016,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "-batchmode -nographics -logFile \"Logs\\current.log\" -SteamAppId={steamAppID}",
				Port = 30000,
				QueryPort = 30001,
				Format = ConfigFormat.StandardINI,
			...
			new() {
				...
				RequiredArgs = "-batchmode -nographics -savefolderpath \"Saves\" -serverip 0.0.0.0 -serverplayers {MaxPlayers} -serverpassword \"{pass}\" -serverpassword_admin \"{adminpass}\" -serverport {port} -serverqueryport {query} -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27016,
			...
			new() {
				...
				RequiredArgs = "-log -useperfthreads -NoAsyncLoadingThread -MaxServerPlayers={MaxPlayers} -PORT={port} -QueryPort={query} -ServerPassword=\"{pass}\" -SteamServerName=\"{ServerName}\" -SteamAppId={steamAppID}",
			...
			new() {
				...
				RequiredArgs = "-Log -SteamServerName=\"{ServerName}\" -PORT={port} -QueryPort={query} -SteamAppId={steamAppID}",
			...
			new() {
				...
				RequiredArgs = "{map}?Game=KFGameContent.KFGameInfo_{mode}?AdminPassword=\"{adminpass}\"?GamePassword=\"{pass}\" -Port={port} -QueryPort={query} -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 27015,
				RelativeConfigPath = @"KFGame\Config\PCServer-KFGame.ini",
				Format = ConfigFormat.StandardINI,
				Maps = ["KF-BioticsLab", "KF-BurningParis", "KF-Outpost", "KF-ZedLanding"],
				GameModes = ["Survival", "VersusSurvival"],
				NeedsConfigWarning = true
			},
			new() {
				Game = "The Front",
			...
			new() {
				...
				RequiredArgs = "-batchmode -nographics -serverName \"{ServerName}\" -password \"{pass}\" -port {port} -maxPlayers {MaxPlayers} -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "4020",
				ExeName = "srcds.exe",
				RequiredArgs = "-game garrysmod -console -port {port} +maxplayers {MaxPlayers} +map {map} +gamemode {mode} +hostname \"{ServerName}\" +sv_password \"{pass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "-servername \"{Identity}\" -SteamAppId={steamAppID}",
				Port = 16261,
				QueryPort = 16262,
			...
			new()
			{
				...
				RequiredArgs = "-batchmode -nographics \"+InternetServer/{Identity}\" +map {map} -port {port} -password \"{pass}\" {mode} -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27016,
			...
			new()
			{
				...
				RequiredArgs = "-noconsole -ignorelastsession -SteamAppId={steamAppID}",
				Port = 27016,
				QueryPort = 27016,
				GameModes = ["Creative"],
			...
			new()
			{
				...
				RequiredArgs = "--galaxy-name \"{map}\" --seed {seed} --server-name \"{ServerName}\" --password \"{pass}\" --port {port} --use-steam-networking 1 -SteamAppId={steamAppID}",
				Port = 27000,
				QueryPort = 27003,
			...
			new() {
				...
				AppID = "276060",
				ExeName = "svends.exe",
				RequiredArgs = "-console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "-batchmode -nographics -exec \"host {port};queryport {query};servername \\\"{ServerName}\\\";addadmin \\\"{adminpass}\\\"\" -logfile \"gamelog.txt\" -SteamAppId={steamAppID}",
				Port = 12871,
				QueryPort = 12881,
				Format = ConfigFormat.StandardINI,
				NeedsConfigWarning = true
			...
			new() {
				...
				AppID = "232330",
				ExeName = "srcds.exe",
				RequiredArgs = "-game cstrike -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" {rcon} +sv_password \"{pass}\"",
				RconSyntax = "+rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "232290",
				ExeName = "srcds.exe",
				RequiredArgs = "-game dod -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" {rcon} +sv_password \"{pass}\" -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "232370",
				ExeName = "srcds.exe",
				RequiredArgs = "-game hl2mp -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" {rcon} +sv_password \"{pass}\" -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "222840",
				ExeName = "srcds.exe",
				RequiredArgs = "-game left4dead -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" {rcon} +sv_password \"{pass}\" -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "462310",
				ExeName = "srcds.exe",
				RequiredArgs = "-game doi -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" {rcon} +sv_password \"{pass}\" -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "237410",
				ExeName = "srcds.exe",
				RequiredArgs = "-game insurgency -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" {rcon} +sv_password \"{pass}\" -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "346680",
				ExeName = "srcds.exe",
				RequiredArgs = "-game bms -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" {rcon} +sv_password \"{pass}\" -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "293030",
				ExeName = "srcds.exe",
				RequiredArgs = "-game contagion -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" {rcon} +sv_password \"{pass}\" -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "295230",
				ExeName = "srcds.exe",
				RequiredArgs = "-game fof -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" {rcon} +sv_password \"{pass}\" -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "17505",
				ExeName = "srcds.exe",
				RequiredArgs = "-game zps -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" {rcon} +sv_password \"{pass}\" -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "255470",
				ExeName = "srcds.exe",
				RequiredArgs = "-game hl1mp -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" {rcon} +sv_password \"{pass}\" -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "90",
				ExeName = "hlds.exe",
				RequiredArgs = "-console -game valve -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "17575",
				ExeName = "srcds.exe",
				RequiredArgs = "-game pvkii -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "-noconsole -ignorelastsession -path \"{map}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27016,
			...
			new() {
				...
				AppID = "381690",
				ExeName = "ROK.exe",
				RequiredArgs = "-batchmode -nographics -port {port} -SteamAppId={steamAppID}",
				Port = 7350,
				QueryPort = 7350,
			...
			new() {
				...
				AppID = "329710",
				ExeName = "srcds.exe",
				RequiredArgs = "-game fortressforever -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "111710",
				ExeName = "srcds.exe",
				RequiredArgs = "-game nucleardawn -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "1136190",
				ExeName = "srcds.exe",
				RequiredArgs = "-game vietnam -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" {rcon} -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "313600",
				ExeName = "srcds.exe",
				RequiredArgs = "-game neotokyo -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "475370",
				ExeName = "srcds.exe",
				RequiredArgs = "-game brainbread2 -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "17525",
				ExeName = "srcds.exe",
				RequiredArgs = "-game synergy -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "383410",
				ExeName = "srcds.exe",
				RequiredArgs = "-game cure -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "17515",
				ExeName = "srcds.exe",
				RequiredArgs = "-game ageofchivalry -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "460040",
				ExeName = "srcds.exe",
				RequiredArgs = "-game empires -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "317670",
				ExeName = "srcds.exe",
				RequiredArgs = "-game nmrih -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" {rcon} +sv_password \"{pass}\" -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "-log -MetaGameServerName=\"{ServerName}\" -Port={port} -QueryPort={query} -ServerPassword=\"{pass}\" -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 7778,
			...
			new() {
				...
				RequiredArgs = "-log -port={port} -QueryPort={query} -MaxPlayers={MaxPlayers} -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 7778,
				NeedsConfigWarning = true
			},
			new() {
				...
				AppID = "673990",
				ExeName = "srcds.exe",
				RequiredArgs = "-game iosoccer -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "985050",
				ExeName = "srcds.exe",
				RequiredArgs = "-game ahl2 -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "+exec server.cfg +gameoptions gameoptions.cfg +port {port} +sessionname \"{ServerName}\" +rcompass \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
				RelativeConfigPath = "server.cfg",
				Format = ConfigFormat.StandardINI,
			...
			new() {
				...
				AppID = "17535",
				ExeName = "srcds.exe",
				RequiredArgs = "-steam -diprip -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "\"{map}.desynced\" -log -Port={port} -QueryPort={query} -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27016,
				Format = ConfigFormat.StandardINI,
				Maps = ["server"],
			...
			new() {
				...
				RequiredArgs = "-nographics -batchmode -localhost -startServer -ignorecompilererrors -maxPlayers {MaxPlayers} -serverName \"{ServerName}\" -worldId 1 -seed {seed} -worldSize {world_size} -mapId {map} -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 7777,
				WorldSeed = "12345",
				WorldSize = 5,
			...
			new() {
				...
				RequiredArgs = "-log -Port={port} -QueryPort={query} -ServerName=\"{ServerName}\" -MaxPlayers={MaxPlayers} -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "-log WorldMapLevel -Port={port} -QueryPort={query} -SteamPort=8766 -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 27015,
				Format = ConfigFormat.StandardINI,
				Maps = ["WorldMapLevel"],
			...
			new() {
				...
				RequiredArgs = "-server -log -Port={port} -QueryPort={query} -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "?AdminPassword=\"{adminpass}\" -server -log -SteamServerName=\"{ServerName}\" -QueryPort={query} -Port={port} -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 27105,
				Format = ConfigFormat.StandardINI,
				NeedsConfigWarning = true
			...
			new() {
				...
				AppID = "17555",
				ExeName = "srcds.exe",
				RequiredArgs = "-console -game esmod -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "-game dystopia -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "17705",
				ExeName = "srcds.exe",
				RequiredArgs = "-steam -insurgency -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
				RelativeConfigPath = @"insurgency\cfg\server.cfg",
			...
			new() {
				...
				RequiredArgs = "{map} -log -Port={port} -nosteamclient -QueryPort={query} -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 27016,
			...
			new() {
				...
				RequiredArgs = "--noinput -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 7776,
				RelativeConfigPath = "server_config.json",
				Format = ConfigFormat.JSON,
			...
			new() {
				...
				RequiredArgs = "{map}?listen?QueryPort={query}?Port={port} -server -log -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "-queryport={query} -log -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "+game facepunch.sandbox {map} +hostname \"{ServerName}\" +port {port} +net_query_port {query} -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27016,
			...
			new() {
				...
				Format = ConfigFormat.StandardINI,
				Maps = ["AOCFFA-Arena3_P", "AOCTO-Battlegrounds_v3_P", "AOCCTF-Moor_p", "AOCLTS-Hillside_P"],
				NeedsConfigWarning = true
			},
			new() {
				Game = "nanos world",
				...
				RequiredArgs = "--name \"{ServerName}\" --map \"{map}\" --port {port} --query_port {query} --max_players {MaxPlayers} --password \"{pass}\" --dedicated_server 1 -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 7778,
				RelativeConfigPath = "Config.toml",
				Format = ConfigFormat.StandardINI,
				Maps = ["nanos-world::BlankMap", "nanos-world::OceanMap", "nanos-world::EmptyMap", "nanos-world::TestingMap"],
				NeedsConfigWarning = true
			},
			new() {
				...
				RequiredArgs = "{map} -log -SEEKFREELOADINGSERVER -Port={port} -QueryPort={query} -maxplayers={MaxPlayers} -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 27015,
				RelativeConfigPath = @"AFFGame\Config\PCServer-AFFGame.ini",
				Format = ConfigFormat.StandardINI,
				Maps = ["AFF-Errah","AFF-Fortress","AFF-Meudeverre","AFF-Ixion"],
				NeedsConfigWarning = true
			},
			new() {
			...
			new() {
				...
				RequiredArgs = "server {map}?game=UDKWickland.UDKWicklandGameTown?dedicated=true -Port={port} -SteamAppId={steamAppID}",
				Port = 7778,
				QueryPort = 7778,
			...
			new() {
				...
				RequiredArgs = "-log -ServerName=\"{ServerName}\" -ServerMaxPlayers={MaxPlayers} -Port={port} -QueryPort={query} {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "-RCONPassword=\"{adminpass}\"",
				Port = 7777,
				QueryPort = 27017,
			...
			new() {
				...
				RequiredArgs = "+sv_hostname \"{ServerName}\" +sv_maxclients {MaxPlayers} +sv_public 1 +sv_gameport {port} +sv_steamport {query} +map {map} -SteamAppId={steamAppID}",
				Port = 25787,
				QueryPort = 25797,
			...
			new() {
				...
				Format = ConfigFormat.StandardINI,
				Maps = ["TD00_Biolab","TD01_Facility","TD02_RadarBase","TD03_CargoShip"],
				GameModes = ["TDTEAMDEATHMATCHGAME","TDATTACKANDDEFENDGAME","TDLASTMANSTANDING"],
				NeedsConfigWarning = true
			},
			new() {
				Game = "Sniper Elite 4",
				...
				RequiredArgs = "-authport 27000 -gameport {port} -lobbyport {query} -updateport 27015 -exec Default.cfg -SteamAppId={steamAppID}",
				Port = 27005,
				QueryPort = 27010,
			...
			new() {
				...
				RequiredArgs = "{mode} -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "4019830",
				ExeName = @"RSDragonwilds.exe",
				RequiredArgs = "-log -NewConsole -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 7777,
			...
			new() {
				...
				RequiredArgs = "-MaxNumPlayers={MaxPlayers} -Port={port} -Password=\"{pass}\" -Gamemode={mode} -SteamAppId={steamAppID}",
				Port = 27001,
				QueryPort = 27002,
			...
			new() {
				...
				AppID = "228780",
				ExeName = @"bin\win32\srcds.exe",
				RequiredArgs = "-console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "-game jbep3 -steam -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" {rcon} -SteamAppId={steamAppID}",
				RconSyntax = "+rcon.port {rcon_port} +rcon.password \"{rcon_pass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "-steam -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "4007540",
				ExeName = "srcds_win64.exe",
				RequiredArgs = "-game tf_goldrush -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "1875500",
				ExeName = "srcds.exe",
				RequiredArgs = "-game treason -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "955080",
				ExeName = "srcds.exe",
				RequiredArgs = "-game tf2008 -steam -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "-steam -game modularcombat -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "2181210",
				ExeName = "srcds.exe",
				RequiredArgs = "-game jbmod -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "/Game/Maps/Universe/L_Persistent_Universe? -server -log -port={port} -map={map} -sessionName=\"{ServerName}\" -QueryPort={query} -SteamAppId={steamAppID}",
				Port = 10000,
				QueryPort = 27016,
			...
			new() {
				...
				RequiredArgs = "/Game/Maps/Lobby/LobbyMap?listen -log -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "-log -server -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "-batchmode -nographics -logfile \"output.txt\" -SteamAppId={steamAppID}",
				Port = 7777,
				QueryPort = 27015,
				RelativeConfigPath = "",
				Format = ConfigFormat.StandardINI,
