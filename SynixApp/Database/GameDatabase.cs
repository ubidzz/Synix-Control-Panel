	...
	public static class GameDatabase
	{
		...
		[
			...
			new() {
				...
				RconSyntax = "+rcon_password \"{adminpass}\"",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "17575",
				ExeName = "srcds.exe",
				RequiredArgs = "-game pvkii -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "329710",
				ExeName = "srcds.exe",
				RequiredArgs = "-game fortressforever -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "111710",
				ExeName = "srcds.exe",
				RequiredArgs = "-game nucleardawn -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "1136190",
				ExeName = "srcds.exe",
				RequiredArgs = "-game vietnam -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "313600",
				ExeName = "srcds.exe",
				RequiredArgs = "-game neotokyo -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "475370",
				ExeName = "srcds.exe",
				RequiredArgs = "-game brainbread2 -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "17525",
				ExeName = "srcds.exe",
				RequiredArgs = "-game synergy -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "383410",
				ExeName = "srcds.exe",
				RequiredArgs = "-game cure -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "17515",
				ExeName = "srcds.exe",
				RequiredArgs = "-game ageofchivalry -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "460040",
				ExeName = "srcds.exe",
				RequiredArgs = "-game empires -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "91720",
				ExeName = "srcds.exe",
				RequiredArgs = "-game eye -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				AppID = "228780",
				ExeName = @"bin\win32\srcds.exe",
				RequiredArgs = "-console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
			...
			new() {
				...
				RequiredArgs = "-game jbep3 -steam -console -port {port} +maxplayers {MaxPlayers} +map {map} +hostname \"{ServerName}\" +sv_password \"{pass}\" +rcon_password \"{adminpass}\" -SteamAppId={steamAppID}",
				Port = 27015,
				QueryPort = 27015,
